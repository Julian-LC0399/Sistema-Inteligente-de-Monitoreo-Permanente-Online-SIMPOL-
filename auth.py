...
def mostrar_login():
    ...
    with col2:
        ...
        st.markdown("<h4 style='text-align: center; color: #333333;'>Sistema Inteligente de Monitoreo Permanente Online</h4>", unsafe_allow_html=True)
        st.write("---")
        
        with st.form("login_form"):
            st.markdown("<p style='color: #003366; font-weight: bold;'>🔐 Acceso al Sistema</p>", unsafe_allow_html=True)
